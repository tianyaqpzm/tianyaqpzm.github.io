 ...
 */
public class T00_06_BlockQueue {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建一个大小为2的阻塞队列
        final BlockingQueue6 q = new BlockingQueue6(2);
...
class BlockingQueue6 {
     ...
     * @param capacity 队列大小
     */
    public BlockingQueue6(int capacity) {
        if (capacity <= 0)
...
//        比如说如果队列并没有为空或者已满时，我们插入或者弹出了元素其实都是不需要唤醒任何线程的，
//        多余的唤醒操作需要先获取ReentrantLock锁才能调用对应的条件变量的signal()方法，
//        而获取锁是一个成本比较大的操作。所以我们最好是能在队列真的为空或者已满以后，成功插入或弹出元素时，再去获取锁并唤醒等待的线程。
